...
export const SidebarData = [
  ...
  },
  {
    ...
    submenuItems: [
      ...
      //   showSubRoute: false,
      //   submenuItems: [
      //     { label: "Leads Dashboard", link: route.contactList, icon:<IoMdPeople /> },
      //     { label: "Leads Details", link: route.contactGrid, icon:<IoMdPeople /> },
      //     { label: "Leads Kanban", link: route.contactDetails, icon:<IoMdPeople /> },
      //   ],
      // },
      {
        label: "Contacts",
        ...
        showSubRoute: false,
        submenuItems: [
          { label: "Contacts Dashboard", link: route.contacts, icon: <IoMdPeople /> },
          // { label: "Contacts Details", link: route.leadsDetails, icon:<IoMdPeople /> },
          // { label: "Contacts Kanban", link: route.leadsKanban, icon:<IoMdPeople /> },
        ],
      },
      ...
      //   showSubRoute: false,
      //   submenuItems: [
      //     { label: "Customer List", link: route.contactList, icon: <IoMdPeople /> },
      ...
      //   showSubRoute: false,
      //   submenuItems: [
      //     { label: "Deal List", link: route.deals, icon:<IoMdPeople /> },
      //     { label: "Deal Details", link: route.dealsDetails, icon:<IoMdPeople /> },
      //     { label: "Deal Grid", link: route.dealsKanban, icon:<IoMdPeople /> },
      //   ],
      // },
      // {
      //   label: "Pipeline",
      ...
      //   showSubRoute: false,
      //   submenuItems: [
      //     { label: "Pipeline", link: route.pipeline, icon:<IoMdPeople /> },
      //   ],
      // },
      // {
      //   label: "Chat",
      ...
      //   showSubRoute: false,
      //   submenuItems: [
      //     { label: "Whatsapp", link: route.Whatsapp, icon:<FaWhatsapp /> },
      //   ],
      // },
      ...
      //   showSubRoute: false,
      //   submenuItems: [
      //     { label: "Deals Dashboard", link: route.leads },
      //     { label: "Leads Dashboard", link: route.leads },
      //     { label: "Project Dashboard", link: route.leads },
      //   ],
      // },
