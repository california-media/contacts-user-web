...
const PlanModal = ({ open, onCancel, onSuccess, plan, type }) => {
  ...
  return (
    <Modal
      title={type === "add" ? "Add New Plan" : "Edit Plan"}
      open={open}
      onCancel={onCancel}
      width={800}
      centered
                ...
                {type === "edit" &&
                  (plan?.name === "Starter" || plan?.name === "Pro") && (
                    <small className="text-muted">
                      Note: The name of {plan?.name} plan cannot be modified as
                      it's a protected plan.
                    </small>
                  )}
              </div>
            </div>
                  ...
                  <div className="features-list">
                    {formData.features.map((feature, index) => (
                      ...
                      >
                        <span
                          className={`me-2 ${
                            feature.isAvailable ? "text-success" : "text-danger"
                          }`}
                        >
                          <i
                            className={`fa fa-${
                        ...
                        <span className="flex-grow-1">{feature.text}</span>
                        <button
                          type="button"
            ...
            <div className="col-md-6 mt-3">
              <div className="form-check form-switch">
                <input
                  ...
                  role="switch"
                />
                <label className="form-check-label">Mark as Popular Plan</label>
              </div>
            </div>
